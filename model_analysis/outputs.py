...
def model_performance_results_combined(experiment_dirs):
    ...
    axes[0].plot(fractions_float, mean_recon, marker="o", linewidth=2)
    axes[0].fill_between(
        fractions_float,
    ...
    for rep_vals in all_reps_recon:
        axes[0].plot(fractions_float, rep_vals, marker="o", alpha=0.4)
    ...
    axes[1].plot(fractions_float, mean_kl, marker="o", linewidth=2)
    axes[1].fill_between(
        fractions_float,
        mean_kl - std_kl,
        mean_kl + std_kl,
    ...
    for rep_vals in all_reps_kl:
        axes[1].plot(fractions_float, rep_vals, marker="o", alpha=0.4)
