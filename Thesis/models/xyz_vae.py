...
class XYZVAE(nn.Module):
    def __init__(self, input_dim, latent_dim):
        ...
        self.dres1 = mlp_block(128, dropout=0.2)
        self.dres2 = mlp_block(256, dropout=0.2)
    ...
    def encode(self, x):
        ...
        mu = 1.0 * torch.tanh(self.z_mean(x))
    ...
    def decode(self, z):
        ...
        y = self.dnorm1(y + self.dres1(y))

        y = F.gelu(self.dec2(y))
        y = self.dnorm2(y + self.dres2(y))
